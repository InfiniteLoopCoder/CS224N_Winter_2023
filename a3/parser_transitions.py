...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if transition == "S":
            ...
            depender = self.stack.pop(-2)
            dependee = self.stack[-1]
            self.dependencies.append((dependee, depender))
        elif transition == "RA":
            dependee = self.stack.pop(-1)
            depender = self.stack[-1]
            self.dependencies.append((depender, dependee))
